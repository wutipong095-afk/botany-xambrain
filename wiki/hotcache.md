...
- **Phase**: **การทำสมองที่สอง** — Layer S (+S8 taxonomy · +M1–M12 monographs รายชนิด) · Layer T ครบ · U1/U2/U3 · AX1+AX2 · เครื่องแนะนำเมนู + wiki · **AI ติวเตอร์ (RAG) MVP ในแอป**
...
- **คิว PDF ถัดไป**: สุพรรณิการ์ · จั๋ง (`สุพรรณิการ์และจั๋งงานกลุ่ม.pdf` — 2 ชนิด) · ประดู่ (มี xlsx) → แล้วค่อยชนิดที่เหลือใน 21
