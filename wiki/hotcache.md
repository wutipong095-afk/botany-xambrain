...
- **Phase**: **การทำสมองที่สอง** — Layer S (+S8 taxonomy · +M1–M18 monographs รายชนิด) · Layer T ครบ · U1/U2/U3 · AX1+AX2 · เครื่องแนะนำเมนู + wiki · **AI ติวเตอร์ (RAG) MVP ในแอป**
...
- **ชุดแหล่งเปิด (ไม่มีไฟล์แนบ) — branch `content/plant-profiles-opensource`** · ข้าม "แค" (ซ้ำ M8) → เหลือ **13 ชนิด** · ทำทีละชุด commit ต่อชุด · ค้นเว็บยืนยัน (WebSearch)
  ...
  - **คิวชุดถัดไป (10 ชนิด)**: ฝรั่งขี้นก · ว่านกาบหอย · ดอนญ่า · เถาแกะ · ไส้ตัน · ตะไคร้ · มะม่วงหาวมะนาวโห่ · มะยม · ยอป่า · หมากเขียว — จัดกลุ่มตามธีมต่อไป (เช่น monocot: ว่านกาบหอย/ตะไคร้/หมากเขียว · ผลไม้พื้นบ้าน: มะยม/มะม่วงหาวมะนาวโห่)
